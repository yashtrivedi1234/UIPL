    ...
    <section className="py-24 px-6 bg-white">
      <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-14 items-center">
        <div className="group relative">
          <div className="absolute -inset-4 rounded-4xl bg-[#0b3c5d]/10 blur-2xl group-hover:bg-[#0b3c5d]/20 transition-all duration-500" />
          <div className="relative overflow-hidden rounded-3xl shadow-2xl h-120">
            ...
            <div className="absolute bottom-6 left-6 text-white">
              <p className="font-black text-xl">Integrated Care Campus</p>
        ...
        <div>
          <h3 className="text-3xl md:text-4xl font-black text-[#00263f] leading-tight mb-5">
