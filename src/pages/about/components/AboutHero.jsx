  ...
  return (
    <section className="relative h-[600px] lg:h-[750px] flex items-center justify-center overflow-hidden">
      <div className="absolute inset-0">
        ...
        />
        {/* Desktop: left-to-right | Mobile: top-to-bottom for readability */}
        <div className="absolute inset-0 bg-gradient-to-b from-[#00263f]/88 to-[#00263f]/70 sm:bg-gradient-to-r sm:from-[#00263f]/85 sm:to-[#00263f]/40" />
      </div>

      <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 w-full text-white">
