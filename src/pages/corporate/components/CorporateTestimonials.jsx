...
const corpTestimonials = [
  {
    quote: 'Moving into a UIPL project changed our definition of luxury. The integration of the school right next to our residence has been a game-changer for our children.',
    name: 'Rajesh Khanna',
  ...
  {
    quote: "UIPL's vision for healthcare infrastructure in Lucknow is unparalleled. Their facilities are designed with international standards of care in mind.",
  ...
  {
    quote: 'As an investor, UIPL offers the most reliable ROI in the Lucknow real estate market. Their delivery timelines and quality are consistent.',
    name: 'Vikram Malhotra',
    role: 'Institutional Investor',
    img: 'https://lh3.googleusercontent.com/aida-public/AB6AXuCGy9ynwMIdaEV752MhLudknhQ7v0f8M3aDcwkmk7CtKW62fsbATIC1hNQz72EV6oRu-7EePT2X7HUo3VSHVm6V6NRk69bzu2hfyaUh9hitrs_N1Ij7X4iIzra0ZfOBuLpi-GUAfvRVO_Tfp1HrIloFfAAqfDU551LzpQdsZKPn7DdZOBFeWbme8NCJFo-nPC0yPo5zf7MfHk6mywkGCW-Uh9S5ntSkfGOhbrt9ELiuU6PDoKDroHeZmkEbluc1k24_40jgGEgBD9s',
    featured: false,
  },
]
    ...
    <section className="py-24 bg-[#eff4ff] overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
          {corpTestimonials.map(({ quote, name, role, img, featured }) => (
            <div
              key={name}
              className={`rounded-2xl p-8 shadow-lg border hover:-translate-y-1 transition-transform duration-300 ${
                featured
                  ? 'bg-white border-white md:scale-110 z-10 shadow-xl'
                  : 'bg-white/60 backdrop-blur border-white/50'
              }`}
            >
              <Quote size={28} className="text-[#fe9824] mb-4" />
              <p className="text-slate-500 italic text-sm leading-relaxed mb-6">"{quote}"</p>
