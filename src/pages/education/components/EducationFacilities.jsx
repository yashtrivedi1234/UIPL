    ...
    <section className="py-24 bg-[#eff4ff]">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-16">
          <h2 className="text-4xl font-black text-[#00263f] mb-4">World-Class Facilities</h2>
          <p className="text-slate-500 max-w-2xl mx-auto leading-relaxed">
            Providing the physical foundation for academic excellence and holistic personal development.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 md:grid-rows-2 gap-6 h-auto md:h-[600px]">
          ...
          <div className="md:col-span-2 md:row-span-2 bg-white/70 backdrop-blur-xl border border-slate-100 rounded-2xl p-8 flex flex-col justify-end relative overflow-hidden group">
            <img
              ...
              className="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-110 opacity-20"
            />
            <div className="relative z-10">
              <div className="text-5xl mb-6">📚</div>
              <h3 className="text-3xl font-black text-[#00263f] mb-4">The Knowledge Hub</h3>
              <p className="text-slate-500 text-sm leading-relaxed">
                Digital and physical archives spanning millions of volumes, equipped with
                high-speed research terminals.
              </p>
            </div>
          </div>
          ...
          <div className="md:col-span-2 bg-white/70 backdrop-blur-xl border border-slate-100 rounded-2xl p-8 flex items-center gap-6 group">
            <div className="p-4 rounded-xl bg-[#0b3c5d]/10 group-hover:bg-[#0b3c5d] transition-colors flex-shrink-0">
              <FlaskConical size={28} className="text-[#0b3c5d] group-hover:text-white transition-colors" />
            </div>
            <div>
              <h3 className="text-xl font-black text-[#00263f] mb-1">Advanced Labs</h3>
              <p className="text-sm text-slate-500">Specialized research centers for STEM and creative arts.</p>
            </div>
          </div>
          ...
          <div className="md:col-span-1 bg-white/70 backdrop-blur-xl border border-slate-100 rounded-2xl p-8 flex flex-col justify-between group">
            ...
            <h3 className="text-lg font-black text-[#00263f]">Sports Arena</h3>
          </div>

          {/* Wellness Center */}
          <div className="md:col-span-1 bg-white/70 backdrop-blur-xl border border-slate-100 rounded-2xl p-8 flex flex-col justify-between group">
            <HeartPulse size={36} className="text-[#002a05]" />
            <h3 className="text-lg font-black text-[#00263f]">Wellness Center</h3>
          </div>
