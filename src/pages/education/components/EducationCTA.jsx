...
export default function EducationCTA() {
  ...
  return (
    <section className="py-8 relative overflow-hidden bg-[#00263f]">
      {/* Gradient overlay */}
      <div
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="bg-white/70 backdrop-blur-xl border border-slate-100 p-12 md:p-20 rounded-2xl flex flex-col items-center text-center">
          <h2 className="text-[#00263f] mb-8 leading-tight">
            Empower Your <br />
          ...
          <div className="flex flex-wrap justify-center gap-6">
            <button
              ...
              className="bg-[#0b3c5d] text-white px-10 py-5 rounded-xl font-black text-xl shadow-2xl hover:scale-105 duration-300"
            >
              Contact Us
            </button>
            <button
              onClick={() => navigate('/projects')}
              className="border-2 border-[#00263f]/20 text-[#00263f] px-10 py-5 rounded-xl font-black text-xl hover:bg-[#00263f]/5 duration-300"
            >
              Download Brochure
            </button>
          </div>
