...
export default function EducationSector() {
  ...
  return (
    <section className="py-8 pb-20 md:pb-24 px-6 bg-[#eff4ff] overflow-hidden relative">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          <div className="w-full lg:w-1/2 order-2 lg:order-1">
            ...
            <button
              ...
              className="group inline-flex items-center justify-center gap-3 bg-[#00263f] text-white px-8 py-4 rounded-xl hover:scale-105 transition-all duration-300 shadow-lg font-black"
            >
      ...
      {/* Wave bottom */}
      <div className="absolute bottom-0 left-0 z-0 w-full overflow-hidden leading-none rotate-180 pointer-events-none">
