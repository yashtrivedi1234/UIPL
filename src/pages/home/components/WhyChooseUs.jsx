      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5 lg:gap-6">
          ...
          <div className="col-span-1 sm:col-span-2 bg-white p-6 sm:p-8 lg:p-10 rounded-2xl shadow-sm border border-slate-100 flex flex-col justify-center">
            <h2 className="text-[#00263f] mb-4 sm:mb-5 leading-tight">
              Built on Foundations of Trust and Innovation
            </h2>
            <p className="text-slate-500 leading-relaxed mb-6 sm:mb-8 max-w-lg">
            ...
            <div className="grid grid-cols-3 gap-3 sm:gap-6 border-t border-slate-100 pt-6 sm:pt-8">
              {[
                ...
                <div key={label}>
                  <div
                    className="text-2xl sm:text-3xl text-[#8d4f00]"
                    style={{ fontFamily: "'Germania One', system-ui", fontWeight: 400 }}
                  >
                    {val}
                  </div>
                  <div
                    className="text-[10px] sm:text-xs text-[#0b3c5d] uppercase tracking-wide mt-1"
          ...
          <div className="col-span-1 bg-[#0b3c5d] p-6 sm:p-8 lg:p-10 rounded-2xl text-white relative overflow-hidden">
            ...
            <h3 className="mb-2 sm:mb-3">Unwavering Trust</h3>
            <p
              className="text-slate-300 leading-relaxed mb-5 sm:mb-6"
            ...
            <Link
              to="/about"
              className="inline-flex items-center gap-2 text-white text-sm hover:gap-4 transition-all"
              style={{ fontFamily: "'Noto Sans', sans-serif", fontWeight: 700 }}
            >
          ...
          <div className="col-span-1 bg-[#8d4f00] p-6 sm:p-8 lg:p-10 rounded-2xl text-white">
            ...
            <h3 className="mb-2 sm:mb-3">Scalable Growth</h3>
            <p
          ...
          <div className="col-span-1 bg-[#002a05] p-6 sm:p-8 lg:p-10 rounded-2xl text-white">
            ...
            <h3 className="mb-2 sm:mb-3">Smart Innovation</h3>
            <p
              className="text-white/80 leading-relaxed"
              style={{ fontFamily: "'Noto Sans', sans-serif", fontSize: 'clamp(0.9rem, 0.85rem + 0.15vw, 1rem)' }}
            >
          ...
          <div className="col-span-1 bg-white p-6 sm:p-8 lg:p-10 rounded-2xl shadow-sm border border-slate-100">
            ...
            <h3 className="text-[#00263f] mb-2 sm:mb-3">Sustainability</h3>
            <p
