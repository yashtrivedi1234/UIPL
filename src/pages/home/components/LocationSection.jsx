...
export default function LocationSection() {
  return (
    <section id="contact" className="relative h-[560px] w-full bg-slate-200 overflow-hidden">
      {/* Map background */}
      <img
        ...
        <div className="bg-white p-9 rounded-2xl shadow-2xl max-w-sm border border-slate-100">
          ...
          <div className="space-y-4">
            <div className="flex gap-3 items-start">
              <MapPin size={18} className="text-[#00263f] mt-0.5 shrink-0" />
              <p className="text-sm font-medium text-slate-700">
                UIPL Tower, Vibhuti Khand, Gomti Nagar, Lucknow, UP 226010
              </p>
            </div>
            <div className="flex gap-3 items-center">
              <Phone size={18} className="text-[#00263f] shrink-0" />
