    ...
    <section id="amenities" className="py-8 sm:py-10 lg:py-12 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-end gap-4 sm:gap-6 mb-10 sm:mb-12 lg:mb-14">
          <div>
            <h2 className="text-[#00263f]">Sectors of Excellence</h2>
            <p className="text-slate-500 mt-2">
              Delivering specialized infrastructure solutions.
            </p>
          </div>
          <button
            onClick={() => navigate('/sectors')}
            className="self-start sm:self-auto text-[#00263f] border-b-2 border-[#00263f] pb-0.5 hover:border-orange-500 hover:text-orange-600 transition-colors text-sm whitespace-nowrap"
          ...
          {sectors.map(({ tag, title, desc, cta, img, alt }) => (
            ...
            >
              ...
              <div className="h-48 sm:h-52 lg:h-60 overflow-hidden relative flex-shrink-0">
                ...
                />
                <div
                  className="absolute top-3 right-3 sm:top-4 sm:right-4 bg-white/90 backdrop-blur px-3 py-1 rounded-full text-[10px] uppercase text-[#00263f] tracking-wide"
              ...
              <div className="p-5 sm:p-6 lg:p-7 flex flex-col flex-1">
                <h3 className="text-[#00263f] mb-2 sm:mb-3">
                  {title}
                </h3>
                <p className="text-slate-500 leading-relaxed mb-5 sm:mb-6 flex-1">
                  {desc}
                </p>
                <button
                  onClick={() => navigate(sectorRouteMap[title] || '/sectors')}
                  className="w-full py-2.5 sm:py-3 rounded-lg border-2 border-[#0b3c5d] text-[#0b3c5d] hover:bg-[#0b3c5d] hover:text-white transition-all duration-300 text-sm"
                  style={{ fontFamily: "'Noto Sans', sans-serif", fontWeight: 700 }}
                >
                  {cta}
                </button>
