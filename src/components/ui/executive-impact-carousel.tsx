...
const CASE_STUDIES: CaseStudy[] = [
  ...
  },
  {
    ...
    afterImg:
      "https://images.unsplash.com/photo-1580281658629-1c7a02a1c7e8?w=800&q=80",
    category: "Healthcare",
  },
  {
    id: "9",
    ...
    afterImg:
      "https://images.unsplash.com/photo-1581091012184-5c2d9d7b9f8f?w=800&q=80",
    category: "Education",
  },
  {
    id: "10",
        ...
        if (containerRef.current) {
          ...
          if (col1Ref.current) {
            gsap.fromTo(
              col1Ref.current,
              { y: -travel / 2 },
              { y: travel / 2, ease: "none", scrollTrigger: scrollConfig },
            );
          }
          if (col3Ref.current) {
            gsap.fromTo(
